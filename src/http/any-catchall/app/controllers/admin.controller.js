...
exports.update_user = async (req, res) => {
    try {
        ...
        // get updated user
        const updated_user_record = await Models.user.findByPk(req.params.userId)
...
exports.sendExpiredEmail = async (req, res) => {
    try {
        ...
        let twoWeeksAgoDate_start = moment(todaysDate).subtract(14, 'days').startOf('day')
        let twoWeeksAgoDate_end = moment(todaysDate).subtract(14, 'days').endOf('day')
