...
exports.signIn = (req, res, next) => {
    ...
    User.findOne({
        ...
        .then(function (user) {
            ...
            if (!isValidPassword(userinfo.password, req.body.password)) {
        ...
        .catch(function (err) {
            ...
            return res.redirect(`/signin?message=sign_in_server_error`)
            // return done(
            //     null,
            //     false,
...
//                         console.log('User entered this ==>', req.body.password)
