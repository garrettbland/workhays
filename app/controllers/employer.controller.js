...
let upload = await multer({ storage: storage, fileFilter: imageFilter, limits: { fileSize: 1 * 1024 * 1024 } }).single('logo_url');
...
upload(req, res, async function(err) {
    ...
    // }
        ...
        req.flash('error', 'Something went wrong updating your business profile. Please try again or contact us.')
    }
